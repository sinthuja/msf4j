...
import org.wso2.msf4j.example.opentracing.OpenTracingInterceptor;
...
public class Application {
    public static void main(String[] args) throws Exception {
        ...
        new MicroservicesRunner(8081)
                .addGlobalRequestInterceptor(OpenTracingInterceptor.getInstance())
                .addGlobalResponseInterceptor(OpenTracingInterceptor.getInstance())
