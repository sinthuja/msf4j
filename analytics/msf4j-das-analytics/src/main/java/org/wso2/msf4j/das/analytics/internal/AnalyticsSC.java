...
*/
package org.wso2.msf4j.das.analytics.internal;
...
/**
 *
 * Bundle Activator for msf4j-das-analytics bundle.
 */
@Component(
        name = "org.wso2.msf4j.das.analytics.httpmonitoringsc",
        immediate = true,
        property = {
                "componentName=msf4j-das-analytics-sc"
        }
)
