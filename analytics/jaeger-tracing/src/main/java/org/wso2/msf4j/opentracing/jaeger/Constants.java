...
/**
 * This is the constants class that defines all the constants that are used by the {@link JaegerOpenTracingExtension}
 */
public class Constants {
    ...
    static final int DEFAULT_REPORTER_PORT = 16686;
